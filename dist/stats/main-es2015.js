...
let ClickableComponent = class ClickableComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
LineChartService.ctorParameters = () => [
...
SectorsComponent.ctorParameters = () => [
...
;
let StateSectorForecastComponent = class StateSectorForecastComponent {
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((response) => {
            ...
            let preData;
            let initData = src_app_charts_data__WEBPACK_IMPORTED_MODULE_3__["datas"].reduce((acc, data) => {
        ...
        let states = src_app_charts_data__WEBPACK_IMPORTED_MODULE_3__["datas"].map((data) => {
            return data.state;
        });
        let iSectors;
        let period = src_app_charts_data__WEBPACK_IMPORTED_MODULE_3__["datas"][0]['period'];
        [iSectors] = period;
...
StateSectorForecastComponent.ctorParameters = () => [
...
;
let StateSectorHistoryComponent = class StateSectorHistoryComponent {
...
StateSectorHistoryComponent.ctorParameters = () => [
...
let StatesConstructionComponent = class StatesConstructionComponent {
    constructor(router) {
        this.router = router;
        this.view = [700, 400];
        this.showXAxis = true;
...
StatesConstructionComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
];
...
let StatesManufacturingComponent = class StatesManufacturingComponent {
    constructor() {
...
let StatesSectorComponent = class StatesSectorComponent {
    constructor(activatedRoute, router) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.view = [700, 400];
    ...
    ngOnInit() {
        this.activatedRoute.params.subscribe((response) => {
            ...
            this.legendTitle = sector;
            this.yAxisTicks = _data__WEBPACK_IMPORTED_MODULE_2__["datas"]['state'];
            let k = [];
            let t = _data__WEBPACK_IMPORTED_MODULE_2__["datas"].reduce((acc, data) => {
...
StatesSectorComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
...
;
;
let BizModelFormComponent = class BizModelFormComponent {
...
BizModelFormComponent.ctorParameters = () => [
...
let BizModelComponent = class BizModelComponent {
    constructor(fb) {
        this.fb = fb;
        this.isLinear = false;
        this.todo = [
...
BizModelComponent.ctorParameters = () => [
...
let BizModelService = class BizModelService {
    constructor(http) {
        this.http = http;
    ...
    edit(input) {
        return this.http.post('api/company/profile/edit', input).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(company => {
...
BizModelService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let BpSetupComponent = class BpSetupComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
const menu01 = { name: 'Main Menu', menus: _menu_data__WEBPACK_IMPORTED_MODULE_1__["menuBusiness"] };
